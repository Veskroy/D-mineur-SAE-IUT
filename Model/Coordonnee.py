...
def getligneCoordonnee(coordonner_tuple):
    if not (len(coordonner_tuple)== 2 and (coordonner_tuple[1]== int and coordonner_tuple[2]==int)):
        raise ValueError ("getLigneCoordonnee : Le paramètre n’est pas une coordonnée")
